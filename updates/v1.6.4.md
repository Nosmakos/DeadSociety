# All the permissions
    ...
    ds.place.<material>       - Permission to place certain crafting blocks that are cancelled(not in the list, Example, a STONE. The permission would be ds.place.stone
    ds.break.<material>
    ds.open.<material>
